...
import br.com.bullsblood.swing.ButtonOutLine;
...
public class PanelCover extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        add(title);
        description = new JLabel("Para se manter conectado conosco, por favor");
        description.setForeground(new Color(245, 245, 245));
        add(description);
        description1 = new JLabel("entre com suas informações pessoais");
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gra = new GradientPaint(0, 0, new Color(158, 2, 2), 0, getHeight(), new Color(110, 1, 1));
        g2.setPaint(gra);
